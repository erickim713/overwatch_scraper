...
function suggestion(){
    ...
    if(checkAll()){
        ...
        if(teamcomp.checkBalance()){
            ...
            console.log("you should balance the composition consider following picks");
        }
        ...
        for (var i = 0; i < myteam.length; i++) {
            if(countered[i] == false){
                suggestionPool.push(counters[i]);
            }
        }

        console.log(suggestionPool);
        // suggestionPool holds the counters information
        // this is for suggestionpool to fill up so that suggestion can be made
